...
public class Pegawai extends javax.swing.JFrame {
    ...
    private void cmbjkActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        {
        } else if (cmbjk.getSelectedItem(). equals ("Laki-Laki")) 
        {
    ...
    private void cmbjabatanActionPerformed(java.awt.event.ActionEvent evt){ 
         ...
         else if (cmbjabatan.getSelectedItem().equals ("Cleaning Service")) {
    ...
    private void cmbjamkerjaActionPerformed(java.awt.event.ActionEvent evt) {
        if (cmbjamkerja.getSelectedItem(). equals ("Pilih Jam Kerja")){
            txtlembur.setText(" ");
        }
        else if (cmbjamkerja.getSelectedItem(). equals ("1 jam")){
            txtlembur.setText("200000");
        }
        else if (cmbjamkerja.getSelectedItem(). equals ("2 jam")){
            txtlembur.setText("250000");
        }
        else if (cmbjamkerja.getSelectedItem(). equals ("3 jam")){
            txtlembur.setText("300000");
        }
        else if (cmbjamkerja.getSelectedItem(). equals ("4 jam")){
            txtlembur.setText("350000");
        }
        else if (cmbjamkerja.getSelectedItem(). equals ("5 jam")){
